...
export default function HomeHeader({
  ...
  return (
    <motion.header
      className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-900 bg-zinc-950/95 backdrop-blur-md"
    ...
    >
      <div className="flex items-center justify-between gap-4 px-4 py-3 md:px-8">
        ...
        >
          <div className="flex w-full overflow-hidden rounded-full border border-zinc-800 bg-zinc-900/90 focus-within:border-zinc-500 transition-colors">
            <input
              type="search"
              value={searchQuery}
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="relative inline-flex items-center justify-center rounded-full border border-zinc-800 bg-zinc-900/90 p-2 text-zinc-300 transition hover:bg-zinc-800 hover:text-white"
              ...
              {showWhatsNew ? (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 top-full z-50 mt-2 w-72 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/95 shadow-2xl backdrop-blur-md"
                  >
                    ...
                    <div className="flex flex-col items-center justify-center py-10 px-4">
                      ...
                      <p className="text-sm text-zinc-400 text-center">No notifications yet</p>
                      <p className="text-xs text-zinc-600 mt-1 text-center">Check back later for updates</p>
                    </div>
                  </motion.div>
                </>
              ) : null}
              ...
              {showProfileMenu ? (
                <>
                  ...
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 8, scale: 0.95 }}
                    transition={{ duration: 0.2 }}
                    className="absolute right-0 top-full z-50 mt-2 w-80 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/95 shadow-2xl backdrop-blur-md"
                  >
